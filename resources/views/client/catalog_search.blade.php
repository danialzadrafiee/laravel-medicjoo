    ...
    <section class="search  px-4 pb-3 bg-white">
        <form action="{{ route('client_catalog_search') }}">
            <div class="flex mt-5 items-center">
                ...
                <div class="js-close-search hidden  rounded flex justify-center items-center w-12 h-12 mr-2 border-2 border-purple-800 text-purple-800"><ion-icon name="chevron-down-outline"></ion-icon></div>
                    ...
                    <div class="col-span-1  border py-5 border-gray-100  ">
                        <div class="item  shadow-md rounded-lg py-4 bg-white mx-3">
                            <div class="image rounded-sm py-4 px-4" style=" aspect-ratio: 1 / 1;">
                                <img src=" {{ asset($stuff->image) }} " class=" rounded   h-full w-full  block mx-auto" alt="" style=" aspect-ratio: 1 / 1;"  >
                            </div>
                            <div class="describe pt-2">
                                <div class="name text-center text-xs  font-bold  ">{{ $stuff->name }}</div>
                                <div class="fast-order px-4">
                                    <a href="#fastmodal" rel="modal:open" data-url="{{ route('stuff_show', $stuff->id) }}"
