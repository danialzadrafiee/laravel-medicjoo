...
@section('content')
    ...
    <section class="offers px-4">
        ...
        تاریخچه سفارش ها
                ...
                <div class="left flex">
                    ...
                    <div class="show js-show">
                        <div class="border cursor-pointer border-gray-300 bg-white rounded px-2 py-2 text-center ml-2 hidden">
        ...
        <div class="list">
                            ...
                            <div class="col-span-6 ">
                                <div class="top">
                                    <div class="flex justify-between mx-3 mt-2">
                                        <div class="time bg-gray-200 rounded px-2 py-1 text-xs">{{ Verta::instance($offer->created_at)->formatDifference()}}</div>
            ...
            @endforeach
            {!! $history->links('pagination::default') !!}
        </div>
    </section>
@endsection
@section('script')
