...
')
     ...
     */ 
        ...
        {
                        return \Ipecompany\Smsirlaravel\Smsirlaravel::DBlog($result, $messages, $numbers);
        }
                    /**
        ...
        {
                        return \Ipecompany\Smsirlaravel\Smsirlaravel::getToken();
        }
                    /**
        ...
        {
                        return \Ipecompany\Smsirlaravel\Smsirlaravel::credit();
        }
                    /**
        ...
        {
                        return \Ipecompany\Smsirlaravel\Smsirlaravel::getLines();
        }
                    /**
         ...
         * @return \Ipecompany\Smsirlaravel\mixed, return status
         * @static 
         */ 
        public static function send($messages, $numbers, $sendDateTime = null)
        {
                        return \Ipecompany\Smsirlaravel\Smsirlaravel::send($messages, $numbers, $sendDateTime);
        }
                    /**
        ...
        {
                        return \Ipecompany\Smsirlaravel\Smsirlaravel::addToCustomerClub($prefix, $firstName, $lastName, $mobile, $birthDay, $categotyId);
        }
                    /**
        ...
        {
                        return \Ipecompany\Smsirlaravel\Smsirlaravel::sendToCustomerClub($messages, $numbers, $sendDateTime, $canContinueInCaseOfError);
        }
                    /**
        ...
        {
                        return \Ipecompany\Smsirlaravel\Smsirlaravel::addContactAndSend($prefix, $firstName, $lastName, $mobile, $message, $birthDay, $categotyId);
        }
                    /**
        ...
        {
                        return \Ipecompany\Smsirlaravel\Smsirlaravel::sendVerification($code, $number, $log);
        }
                    /**
         * 
         *
        ...
        {
                        return \Ipecompany\Smsirlaravel\Smsirlaravel::ultraFastSend($parameters, $template_id, $number);
        }
                    /**
        ...
        {
                        return \Ipecompany\Smsirlaravel\Smsirlaravel::getReceivedMessages($perPage, $pageNumber, $formDate, $toDate);
        }
                    /**
        ...
        {
                        return \Ipecompany\Smsirlaravel\Smsirlaravel::getSentMessages($perPage, $pageNumber, $formDate, $toDate);
        }
                    /**
         * 
         *
        ...
        {
                        return \Ipecompany\Smsirlaravel\Smsirlaravel::deleteContact($mobile);
        }
     ...
     */ 
         ...
         * @param \Kreait\Firebase\Contract\Uid|string $uid
     ...
     */ 
         ...
         * 
         *
         * @param string|\Url|\Kreait\Firebase\UriInterface|mixed $mixedLinksDomain
         * @static 
         */ 
...
namespace  { 
            ...
            class Smsirlaravel extends \Ipecompany\Smsirlaravel\SmsirlaravelFacade {}
